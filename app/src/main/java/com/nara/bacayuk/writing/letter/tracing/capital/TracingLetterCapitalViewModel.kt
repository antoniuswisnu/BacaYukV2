...
class TracingLetterCapitalViewModel (
    ...
    private val _reportTulisHurufKapital = MutableLiveData<Response<List<ReportTulisHuruf>>>()
    val reportTulisHurufKapital: LiveData<Response<List<ReportTulisHuruf>>> = _reportTulisHurufKapital

    fun updateReportHurufKapital(
        idUser: String,
        idStudent: String,
    ...
    fun getReportTulisHurufKapital(idUser: String, idStudent: String) {
        viewModelScope.launch {
            reportUseCase.getAllReportTulisHurufFromFirestore(idUser, idStudent).collect { response ->
                _reportTulisHurufKapital.value = response
            }
        }
    }
